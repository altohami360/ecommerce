<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ request()->is('admins*') ? 'active' : '' }}" href="{{ route('admins.index') }}"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">administrators</span></a></li>
        <li><a class="app-menu__item {{ request()->is('admins*') ? 'active' : '' }}" href="{{ route('products.index') }}"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Products</span></a></li>
